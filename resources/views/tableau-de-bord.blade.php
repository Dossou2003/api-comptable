            ...
            <div class="col-md-3 mb-4">
                <div class="card text-white bg-primary">
                    <div class="card-body">
                        ...
                        <a href="{{ route('clients.index') }}" class="btn btn-light">Voir tous</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card text-white bg-success">
                    <div class="card-body">
                        ...
                        <p class="card-text display-4">0</p>
                        <a href="{{ route('factures.index') }}" class="btn btn-light">Voir toutes</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card text-white bg-info">
                    <div class="card-body">
                        ...
                        <p class="card-text display-4">0</p>
                        <a href="{{ route('produits.index') }}" class="btn btn-light">Voir tous</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card text-white bg-warning">
                    <div class="card-body">
                        ...
                        <p class="card-text display-4">0</p>
                        <a href="{{ route('categories.index') }}" class="btn btn-light">Voir toutes</a>
                    </div>
                </div>
            </div>
        </div>
