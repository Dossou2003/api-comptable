...
<head>
    ...
    <title>Liste des Clients - Comptabilité</title>
    ...
    <div class="container mt-4">
        <div class="row mb-3">
            ...
            <div class="col-md-6 text-end">
                <a href="{{ route('clients.creer') }}" class="btn btn-primary">Ajouter un client</a>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($clients as $client)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('clients.afficher', $client) }}" class="btn btn-sm btn-info">Voir</a>
                                    <a href="{{ route('clients.modifier', $client) }}" class="btn btn-sm btn-warning">Modifier</a>
                                    <a href="{{ route('clients.supprimer', $client) }}" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?')">Supprimer</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
